...
#     result = ""
#     r = requests.get(url_header, headers=header)
...
#   marker = folium.Marker([latitude, logitude], popup=shopinfo, icon=folium.Icon(color=mycolor, icon='info-sign')).add_to(mapObject)
